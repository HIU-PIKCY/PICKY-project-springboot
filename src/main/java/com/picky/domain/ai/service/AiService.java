...
public class AiService {
    ...
    private String createPrompt(String questionTitle, String questionContent, List<String> comments) {
        ...
        return String.format(
            """
                    ...
                    [작업]
                    1. 토론의 핵심 내용을 단순히 요약하는 대신, 댓글에서 나타나는 다양한 시각이나 대립하는 의견들을 중심으로 토론의 양상을 설명해주세요. 예를 들어, "%s" 와 같이 제3자 관찰자 시점의 간결한 한 문장으로 작성해주세요. 문장은 반드시 '~다.'로 끝나야 합니다.
                    2. 이 토론의 핵심을 나타내는 해시태그를 3개만 생성해주세요. '#'으로 시작하고 콤마(,)로 구분해주세요. (예: #토론,#서사불쌍,#무한공감)
    ...
    private String createQuestionPrompt(String bookTitle, String author, String theme) {
        return String.format(
                ...
                8. 질문은 하나만 작성하세요. 문장이 너무 길지 않도록 작성하세요.
                9. 질문 의도나 배경은 설명하지 말고, 사용자들과 논의하고 싶은 핵심 주제만을 질문 형태로 제시하세요.
                10. 일반 사용자인 것처럼 작성하세요. '독자들'과 '여러분'과 같은 단어는 사용하지 말고, 자연스러운 말투를 사용하세요.
    ...
    private String createAnswerPrompt(String bookTitle, String author, String questionContent) {
        return String.format(
                ...
                3. 답변 생성: 위 분석과 해석을 종합하여, 아래 [참고 예시]를 참고하여 답변을 완성합니다.
                            ...
                            4. 답변은 최대 세 문장으로 제한합니다. 한 문장이 너무 길지 않게 작성하세요.
