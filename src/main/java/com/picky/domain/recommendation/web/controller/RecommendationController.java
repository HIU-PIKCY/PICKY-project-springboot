...
public class RecommendationController {
    ...
    @Operation(
            summary = "질문 기반 책 추천 API",
            description = "사용자가 가장 많이 사용한 키워드를 분석하여 같은 키워드를 사용한 다른 사용자들의 질문과 연결된 책을 추천합니다."
    )
    @GetMapping("/question-based")
    public ApiResponse<BookRecommendationDTO> getPersonalizedRecommendation(
